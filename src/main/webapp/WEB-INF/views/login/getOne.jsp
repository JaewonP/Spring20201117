...
<div class="row">
	...
	<form id="myForm" action="login/getOne" method="post">
	        <div class="form-group">
                <label>번호</label><input class="form-control" name="free_id" value='<c:out value="${login.free_id}"/>' readonly="readonly">
            </div>
            <div class="form-group">
                <label>아이디</label><input class="form-control" name="free_name" value='<c:out value="${login.free_name}"/>' readonly="readonly">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
            	<label>주민번호</label><input class="form-control" name="juminNo" value='<c:out value="${login.juminNo}"/>' readonly="readonly">
            </div>
            <div class="form-group">
            	<label>집전화번호</label><input class="form-control" name="homeNum" value='<c:out value="${login.homeNum}"/>' readonly="readonly">
            </div>
            <div class="form-group">
            ...
            <button type="button" class="btn btn-warning" onclick="location.href='/login/buy?free_id=<c:out value="${login.free_id}"/>'">구매하기</button>
            <button type="button" class="btn btn-warning" onclick="location.href='/login/return?free_id=<c:out value="${login.free_id}"/>'">반품하기</button>
        </div> 
    </div>
</div>

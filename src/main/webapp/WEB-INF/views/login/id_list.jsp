                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <c:forEach items="${list}" var ="login" varStatus="status">
                    <tr>
                      ...
                      <td><a href='/login/getOne?free_id=<c:out value="${login.free_id}"/>'>
                      <c:out value="${login.detail_address}"></c:out></a></td>
                      <td><c:out value="${login.juminNo}"></c:out></td>
                      <td><c:out value="${login.homeNum}"></c:out></td>
